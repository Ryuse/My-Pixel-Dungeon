...
public class ItemSpriteSheet {
	...
	public static final int TRAINING_WHIP	= WEP_TIER1+6;
	static{
		assignItemRect(WORN_SHORTSWORD, 13, 13);
		assignItemRect(GLOVES,          12, 16);
		assignItemRect(DAGGER,          12, 13);
		assignItemRect(MAGES_STAFF,     15, 16);
		assignItemRect(TRAINING_WHIP,   14, 14);
	}
	...
	public static final int SUMMONER_WHIP   = WEP_TIER5+6;
	static{
		...
		assignItemRect(SUMMONER_WHIP,	16, 16);
	}
	...
	public static final int ARMOR_SUMMONER  = ARMOR+9;
	static{
		...
		assignItemRect(ARMOR_SUMMONER,  16, 16);
	...
	static{
		...
		assignItemRect(EXTRACTION_FLASK,    9,  16);
		assignItemRect(URN_OF_SHADOW,		11, 15);
		assignItemRect(DEMONIC_SKULL,		13, 14);
		assignItemRect(UNHOLY_BLOOD,		11, 13);
		assignItemRect(MASK_OF_MADNESS,		13, 13);
		assignItemRect(ASTROLABE,			14, 14);
		assignItemRect(ASTROLABE_1,			14, 14);
		assignItemRect(ASTROLABE_2,			14, 14);
		assignItemRect(BONE_HAND,			15, 15);

	}
	public static final int EYE_OF_WISDOM 		= xy(1, 38);  //32 slots
	static {
		assignItemRect(EYE_OF_WISDOM,      14,  12);
	}
	                                                                                    //16 free slots
	...
	private static final int DARKEST_PLACEHOLDER = xy(1,33);
	public static final int HELMET_HOLDER = DARKEST_PLACEHOLDER+0;

	private static final int HELMET = xy(1, 35);
