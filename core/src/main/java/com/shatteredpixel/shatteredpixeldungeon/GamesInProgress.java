...
public class GamesInProgress {
	...
	public static Info check( int slot ) {
		...
		if (slotStates.containsKey( slot )) {
			...
			try {
				...
				if (info.version < com.shatteredpixel.shatteredpixeldungeon.ShatteredPixelDungeon.v0_7_5e) {
					info = null;
				}
	...
	public static void set(int slot, int depth, int challenges,
		...
		info.goldCollected = com.shatteredpixel.shatteredpixeldungeon.Statistics.goldCollected;
