...
public enum Rankings {
	...
	public void saveGameData(Record rec){
		...
		if (belongings.artifacts_list.get(1) != null)        belongings.backpack.items.add(belongings.artifacts_list.get(1));
		if (belongings.rings_list.get(0) != null)        belongings.backpack.items.add(belongings.rings_list.get(0));
