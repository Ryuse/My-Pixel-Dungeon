...
public class WndSadGhost extends Window {
		...
		switch (type){
			case 1:default:
				...
				if (Dungeon.hero.heroClass == HeroClass.SUMMONER){
					message = PixelScene.renderTextBlock( Messages.get(this, "rat")+Messages.get(this, "give_item_summoner"), 6 );
				}
				else{
			...
			case 2:
				...
				if (Dungeon.hero.heroClass == HeroClass.SUMMONER){
					message = PixelScene.renderTextBlock( Messages.get(this, "gnoll")+Messages.get(this, "give_item_summoner"), 6 );
				}
				else{
			...
			case 3:
				...
				if (Dungeon.hero.heroClass == HeroClass.SUMMONER){
					message = PixelScene.renderTextBlock( Messages.get(this, "crab")+Messages.get(this, "give_item_summoner"), 6 );
				}
				else{
	...
	private void selectReward( Ghost ghost, Item reward ) {
		...
		if(Dungeon.hero.heroClass == HeroClass.SUMMONER){
			ghost.yell( Messages.get(this, "farewell_summoner") );
		}
		else{
