...
public class InterlevelScene extends PixelScene {
	...
	public void create() {
		...
		else if (loadingDepth <= 10)    loadingAsset = Assets.Interfaces.LOADING_POLLUTED_SEWERS;
		else if (loadingDepth <= 15)    loadingAsset = Assets.Interfaces.LOADING_PRISON;
		else if (loadingDepth <= 20)    loadingAsset = Assets.Interfaces.LOADING_CAVES;
		else if (loadingDepth <= 25)    loadingAsset = Assets.Interfaces.LOADING_CITY;
		else if (loadingDepth <= 30)    loadingAsset = Assets.Interfaces.LOADING_HALLS;
