...
public class ShatteredPixelDungeon extends Game {
	...
	public void create() {
		...
		Music.INSTANCE.enable( com.shatteredpixel.shatteredpixeldungeon.SPDSettings.music() );
		Music.INSTANCE.volume( com.shatteredpixel.shatteredpixeldungeon.SPDSettings.musicVol()* com.shatteredpixel.shatteredpixeldungeon.SPDSettings.musicVol()/100f );
		Sample.INSTANCE.enable( com.shatteredpixel.shatteredpixeldungeon.SPDSettings.soundFx() );
		Sample.INSTANCE.volume( com.shatteredpixel.shatteredpixeldungeon.SPDSettings.SFXVol()* SPDSettings.SFXVol()/100f );
