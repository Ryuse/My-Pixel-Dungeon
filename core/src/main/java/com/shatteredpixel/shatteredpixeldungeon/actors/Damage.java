...
public class Damage {
  ...
  public com.shatteredpixel.shatteredpixeldungeon.actors.Damage type(Type t) {
    type = t;
    return this;
  }

  public com.shatteredpixel.shatteredpixeldungeon.actors.Damage addElement(int e) {
    element = element | e;
    return this;
  }

  public com.shatteredpixel.shatteredpixeldungeon.actors.Damage addFeature(int f) {
    feature = feature | f;
    return this;
  }
