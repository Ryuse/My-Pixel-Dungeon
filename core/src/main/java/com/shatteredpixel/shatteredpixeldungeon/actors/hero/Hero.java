...
public class Hero extends Char {
	...
	public int additionalAttackSkill = 0;
	public int defenseSkill = 5;
	public int additionalDefenseSkill = 0;
	...
	public int lvl = 1;
	public int additionalLvl = 0;
	public int exp = 0;
	
	public int HTBoost = 0;
	public int additionalHT = 0;
	...
	public int STR() {
		...
		STR += RingOfMight.strengthBonus( this ) + (int)((double)this.lvl/10) ;
	...
	private static final String ADDITIONAL_ATTACK	= "additionalAttackSkill";
	private static final String DEFENSE				= "defenseSkill";
	private static final String ADDITIONAL_DEFENSE	= "additionalDefenseSkill";
	private static final String STRENGTH			= "STR";
	private static final String LEVEL				= "lvl";
	private static final String ADDITIONAL_LEVEL		= "additionalLvl";
	private static final String EXPERIENCE			= "exp";
	private static final String HTBOOST     		= "htboost";
	private static final String ADDITIONAL_HT     		= "additionalHT";
	...
	public void storeInBundle( Bundle bundle ) {
		...
		bundle.put( ADDITIONAL_ATTACK, additionalAttackSkill );
		bundle.put( DEFENSE, defenseSkill );
		bundle.put( ADDITIONAL_DEFENSE, additionalDefenseSkill );

		bundle.put( STRENGTH, STR );
		
		bundle.put( LEVEL, lvl );
		bundle.put( ADDITIONAL_LEVEL, additionalLvl);
		bundle.put( EXPERIENCE, exp );
		
		bundle.put( HTBOOST, HTBoost );
		bundle.put( ADDITIONAL_HT, additionalHT);
	...
	public void restoreFromBundle( Bundle bundle ) {
		...
		additionalLvl = bundle.getInt( ADDITIONAL_LEVEL );
		exp = bundle.getInt( EXPERIENCE );

		HTBoost = bundle.getInt(HTBOOST);
		additionalHT = bundle.getInt(ADDITIONAL_HT);
		...
		additionalAttackSkill = bundle.getInt( ADDITIONAL_ATTACK );
		defenseSkill = bundle.getInt( DEFENSE );
		additionalDefenseSkill = bundle.getInt( ADDITIONAL_DEFENSE );
	...
	public int tier() {
		int highest_tier = 0;
		for(int i = 0; i < belongings.armors_list.size(); i++){
			if(belongings.armors_list.get(i) != null && belongings.armors_list.get(i).tier > highest_tier){
				highest_tier = belongings.armors_list.get(i).tier;
			}
		}
		return highest_tier;
	}
	...
	public int attackSkill( Char target ) {
		...
		accuracy += (int)((double)this.lvl/10);
	...
	public int defenseSkill( Char enemy ) {
		...
		float evasion = defenseSkill + additionalDefenseSkill;
		...
		for(int i = 0; i < belongings.armors_list.size(); i++){
			if(belongings.armors_list.get(i) != null){
	...
	public int drRoll() {
		...
		for(int i = 0; i < belongings.armors_list.size(); i++){
			if(belongings.armors_list.get(i) != null){
				int armDr = Random.NormalIntRange( belongings.armors_list.get(i).DRMin(), belongings.armors_list.get(i).DRMax());
				if (STR() < belongings.armors_list.get(i).STRReq()){
					armDr -= 2*(belongings.armors_list.get(i).STRReq() - STR());
				}
				if (armDr > 0) dr += armDr;
			}
		}
	...
	//This one determines how much damage you'll do
	@Override
	...
	public float speed() {
		...
		speed += (int)((double)this.lvl/50);

		for(int i = 0; i < belongings.armors_list.size(); i++){
			if(belongings.armors_list.get(i) != null){
				speed = belongings.armors_list.get(i).speedFactor(this, speed);
			}
		}
	...
	public int defenseProc( Char enemy, int damage ) {
		...
		for(int i = 0; i < belongings.armors_list.size(); i++){
			if(belongings.armors_list.get(i) != null){
				damage = belongings.armors_list.get(i).proc( enemy, this, damage );
			}
		}
	...
	public void damage( int dmg, Object src ) {
		...
		for(int i = 0; i < belongings.armors_list.size(); i++){
			if(
					belongings.armors_list.get(i) != null
					&& belongings.armors_list.get(i).hasGlyph(AntiMagic.class, this)
					&& AntiMagic.RESISTS.contains(src.getClass()))
			{
				dmg -= AntiMagic.drRoll(belongings.armors_list.get(i).buffedLvl());
			}
		}
	...
	public void earnExp( int exp, Class source ) {
		...
		while (this.exp >= maxExp()) {
			this.exp -= maxExp();
			if (lvl < (MAX_LEVEL+additionalLvl)) {
				lvl++;
				levelUp = true;
	...
	public float stealth() {
		...
		for(int i = 0; i < belongings.armors_list.size(); i++){
			if(belongings.armors_list.get(i) != null) {
				stealth = belongings.armors_list.get(i).stealthFactor(this, stealth);
			}
		}
	...
	public boolean isImmune(Class effect) {
		if (effect == Burning.class){
			for(int i = 0; i < belongings.armors_list.size(); i++){
				if(belongings.armors_list.get(i) != null && belongings.armors_list.get(i).hasGlyph(Brimstone.class, this)) {
					return true;
				}
			}
		}
		if (effect == Charm.class){
			if (subClass == HeroSubClass.ATTRACTOR ){
				return true;
			}
		}
