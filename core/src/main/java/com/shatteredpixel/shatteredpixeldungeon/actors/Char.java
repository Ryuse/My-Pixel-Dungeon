...
public abstract class Char extends Actor {
	...
	public String name(){
		if(Dungeon.hero.heroClass == HeroClass.SUMMONER){
			if(this instanceof Ghost || this instanceof DriedRose.GhostHero){
				return Messages.get(this, "name_summoner");
			};
		}
	...
	public boolean attack( Char enemy ) {
		...
		boolean[] hit_crit = hit( this, enemy, false );
		...
		if (enemy.isInvulnerable(getClass())) {
			...
			if(hit_crit[1]){
				enemy.sprite.showStatus(CharSprite.NEGATIVE, Messages.get(Preparation.class, "critical"));
			}
	...
	//This determines whether things hit or not
	public static boolean[] hit( Char attacker, Char defender, boolean magic ) {
		...
		boolean hits = (magic ? acuRoll * 2 : acuRoll) >= defRoll;
		boolean crits = (acuRoll/defRoll) >= 15;

		boolean[] hit_crit = {hits, crits};

		//Magic is busted man. It doubles accuracy
//		return (magic ? acuRoll * 2 : acuRoll) >= defRoll;
	...
	public void damage( int dmg, Object src ) {
		...
		//This one shows the damage effect
		if (sprite != null) {
			sprite.showStatus(HP > HT / 2 ? CharSprite.WARNING : CharSprite.NEGATIVE, Integer.toString(dmg + shielded));
		}
