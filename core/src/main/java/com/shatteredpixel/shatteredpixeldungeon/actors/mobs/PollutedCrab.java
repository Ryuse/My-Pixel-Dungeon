...
import com.shatteredpixel.shatteredpixeldungeon.sprites.PollutedCrabSprite;
...
public class PollutedCrab extends Crab {

	{
		spriteClass = PollutedCrabSprite.class;

		HP = HT = 25;
		defenseSkill = 10; //see damage()
		baseSpeed = 1f;
