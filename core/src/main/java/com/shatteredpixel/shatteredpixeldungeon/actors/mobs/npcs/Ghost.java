		...
		if (Quest.given) {
							...
							switch (Quest.type) {
								...
								default:
									if (Dungeon.hero.heroClass == HeroClass.SUMMONER) {
										GameScene.show(new WndQuest(Ghost.this, Messages.get(Ghost.this, "rat_2_summoner")));
									}
									else{
								...
								case 2:
									if (Dungeon.hero.heroClass == HeroClass.SUMMONER) {
										GameScene.show(new WndQuest(Ghost.this, Messages.get(Ghost.this, "gnoll_2_summoner")));
									}
									else{
								...
								case 3:
									if (Dungeon.hero.heroClass == HeroClass.SUMMONER) {
										GameScene.show(new WndQuest(Ghost.this, Messages.get(Ghost.this, "crab_2_summoner")));
									}
									else{
			...
			switch (Quest.type){
				case 1: default:
					...
					if (Dungeon.hero.heroClass == HeroClass.SUMMONER){
						txt_quest = Messages.get(this, "rat_1_summoner", Dungeon.hero.name());
					}
					else{
				...
				case 2:
					...
					if (Dungeon.hero.heroClass == HeroClass.SUMMONER) {
						txt_quest = Messages.get(this, "gnoll_1_summoner", Dungeon.hero.name());
					}
					else{
				...
				case 3:
					...
					if (Dungeon.hero.heroClass == HeroClass.SUMMONER) {
						txt_quest = Messages.get(this, "crab_1_summoner", Dungeon.hero.name());
					}
					else{
	...
	public static class Quest {
		...
		public static void spawn( SewerLevel level ) {
			if (!spawned && Dungeon.depth > 1 && Random.Int( 5 - Dungeon.depth ) == 0) {
				...
				if (itemLevelRoll < 0.3f){
					...
					itemLevel += 2 ;
				} else if (itemLevelRoll < 0.50f){
					itemLevel += 3;
				} else if (itemLevelRoll < 0.53f){
					itemLevel += 4;
				...
				//10% to be enchanted
				if (Random.Int(enchantChanceMax) == 0){
					weapon.enchant();
					armor.inscribe();
				}
		...
		public static void process() {
			if (spawned && given && !processed && (depth == Dungeon.depth)) {
				if(Dungeon.hero.heroClass == HeroClass.SUMMONER){
					GLog.n( Messages.get(Ghost.class, "find_me_summoner") );
				}
				else{
