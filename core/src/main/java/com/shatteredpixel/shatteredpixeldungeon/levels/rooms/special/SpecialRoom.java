...
import com.shatteredpixel.shatteredpixeldungeon.levels.rooms.special.RatNestRoom;
...
public abstract class SpecialRoom extends Room {
	...
	private static final ArrayList<Class<? extends SpecialRoom>>
			ALL_SPEC = new ArrayList<>(
					Arrays.asList(
							WeakFloorRoom.class,
							MagicWellRoom.class,
							CryptRoom.class,
	...
	public static void initForFloor(){
		...
		if (Dungeon.depth == 4){
			floorSpecials.add(0, RatNestRoom.class);
		}
	}
