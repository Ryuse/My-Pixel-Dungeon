...
import com.shatteredpixel.shatteredpixeldungeon.levels.EyeOfWisdomLevel;
...
public class Dungeon {
	...
	public static com.shatteredpixel.shatteredpixeldungeon.QuickSlot quickslot = new QuickSlot();
...
//		if (depth == 1){
//			level = new EyeOfWisdomLevel();
//		}
//		else
		if (sewers.contains(depth))
		{
	...
	public static boolean bossLevel( int depth ) {
		return depth == 10 || depth == 15 || depth == 20 || depth == 25 || depth == 30;
	}
	...
	public static void switchLevel( final Level level, int pos ) {
		...
		if(level instanceof EyeOfWisdomLevel){
			hero.viewDistance = 30;
		}
	...
	public static void fail( Class cause ) {
		if (hero.belongings.getItem( Ankh.class ) == null) {
			com.shatteredpixel.shatteredpixeldungeon.Rankings.INSTANCE.submit( false, cause );
		}
	}
