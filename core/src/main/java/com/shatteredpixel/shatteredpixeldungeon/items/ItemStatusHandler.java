...
public class ItemStatusHandler<T extends com.shatteredpixel.shatteredpixeldungeon.items.Item> {
	...
	public void saveSelectively( Bundle bundle, ArrayList<com.shatteredpixel.shatteredpixeldungeon.items.Item> itemsToSave ){
		List<Class<? extends T>> items = Arrays.asList(this.items);
		for (com.shatteredpixel.shatteredpixeldungeon.items.Item item : itemsToSave){
	...
	public void saveClassesSelectively( Bundle bundle, ArrayList<Class<?extends com.shatteredpixel.shatteredpixeldungeon.items.Item>> clsToSave ){
		List<Class<? extends T>> items = Arrays.asList(this.items);
		for (Class<?extends com.shatteredpixel.shatteredpixeldungeon.items.Item> cls : clsToSave){
	...
	public boolean contains( T item ){
		for (Class<?extends com.shatteredpixel.shatteredpixeldungeon.items.Item> i : items){
