...
public class RingOfSharpshooting extends Ring {
	...
	public String statsInfo() {
		if (isIdentified()){
			return Messages.get(this, "stats", soloBuffedBonus(), new DecimalFormat("#.##").format(100f * (Math.pow(1.5, soloBonus()) - 1f)));
		} else {
	...
	public static float durabilityMultiplier( Char target ){
		return (float)(Math.pow(1.5, getBonus(target, Aim.class)));
	}
