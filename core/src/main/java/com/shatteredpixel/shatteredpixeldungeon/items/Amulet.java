...
public class Amulet extends Item {
	...
	public boolean doPickUp( Hero hero ) {
		if (super.doPickUp( hero )) {
			...
			if (!com.shatteredpixel.shatteredpixeldungeon.Statistics.amuletObtained) {
		...
		try {
			...
			Game.switchScene( AmuletScene.class, new Game.SceneChangeCallback() {
				...
				public void afterCreate() {
					...
					com.shatteredpixel.shatteredpixeldungeon.Badges.validateChampion(Challenges.activeChallenges());
					Badges.saveGlobal();
				}
			});
		} catch (IOException e) {
