...
import com.shatteredpixel.shatteredpixeldungeon.actors.buffs.Insight;
...
public class EyeOfWisdom extends Artifact {

	{
		image = ItemSpriteSheet.EYE_OF_WISDOM;
...
//					exp -= 100 + 50*level();
//					upgrade();
//					GLog.p( Messages.get(EyeOfWisdom.class, "levelup") );
//				}
//				updateQuickslot();
//
...
//			return Messages.get(EyeOfWisdom.class, "prompt");
//		}
//	};
	...
	public class Insight extends ArtifactBuff{
...
//					partialCharge = 0;
//					GLog.p( Messages.get(EyeOfWisdom.class, "full_charge") );
//				}
//			}
