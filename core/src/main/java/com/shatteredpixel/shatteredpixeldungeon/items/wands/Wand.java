...
public abstract class Wand extends Item {
	...
	public int buffedLvl() {
		...
		if (curUser != null) {
			com.shatteredpixel.shatteredpixeldungeon.items.wands.WandOfMagicMissile.MagicCharge buff = curUser.buff(com.shatteredpixel.shatteredpixeldungeon.items.wands.WandOfMagicMissile.MagicCharge.class);
	...
	protected void wandUsed() {
		...
		com.shatteredpixel.shatteredpixeldungeon.items.wands.WandOfMagicMissile.MagicCharge buff = curUser.buff(WandOfMagicMissile.MagicCharge.class);
	...
	public Item random() {
		...
		if (itemLevelRoll < 0.25f){
			itemLevel += 1;
		} else if (itemLevelRoll < 0.30f){
			itemLevel += 2 ;
		} else if (itemLevelRoll < 0.40f){
			itemLevel += 3;
		} else if (itemLevelRoll < 0.43f){
			itemLevel += 4;
