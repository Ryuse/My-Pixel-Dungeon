...
public class Ankh extends Item {
	...
	public ArrayList<String> actions( Hero hero ) {
		...
		com.shatteredpixel.shatteredpixeldungeon.items.DewVial vial = hero.belongings.getItem(com.shatteredpixel.shatteredpixeldungeon.items.DewVial.class);
	...
	public void execute( final Hero hero, String action ) {
		...
		if (action.equals( AC_BLESS )) {
			...
			com.shatteredpixel.shatteredpixeldungeon.items.DewVial vial = hero.belongings.getItem(DewVial.class);
			if (vial != null){
				blessed = true;
				vial.empty();
