...
public class Badges {
	...
	public static void validateMonstersSlain() {
		...
		if (!local.contains( Badge.MONSTERS_SLAIN_1 ) && com.shatteredpixel.shatteredpixeldungeon.Statistics.enemiesSlain >= 10) {
			badge = Badge.MONSTERS_SLAIN_1;
			local.add( badge );
		}
		if (!local.contains( Badge.MONSTERS_SLAIN_2 ) && com.shatteredpixel.shatteredpixeldungeon.Statistics.enemiesSlain >= 50) {
			badge = Badge.MONSTERS_SLAIN_2;
			local.add( badge );
		}
		if (!local.contains( Badge.MONSTERS_SLAIN_3 ) && com.shatteredpixel.shatteredpixeldungeon.Statistics.enemiesSlain >= 150) {
			badge = Badge.MONSTERS_SLAIN_3;
			local.add( badge );
		}
		if (!local.contains( Badge.MONSTERS_SLAIN_4 ) && com.shatteredpixel.shatteredpixeldungeon.Statistics.enemiesSlain >= 250) {
	...
	public static void validateGoldCollected() {
		...
		if (!local.contains( Badge.GOLD_COLLECTED_1 ) && com.shatteredpixel.shatteredpixeldungeon.Statistics.goldCollected >= 100) {
			badge = Badge.GOLD_COLLECTED_1;
			local.add( badge );
		}
		if (!local.contains( Badge.GOLD_COLLECTED_2 ) && com.shatteredpixel.shatteredpixeldungeon.Statistics.goldCollected >= 500) {
			badge = Badge.GOLD_COLLECTED_2;
			local.add( badge );
		}
		if (!local.contains( Badge.GOLD_COLLECTED_3 ) && com.shatteredpixel.shatteredpixeldungeon.Statistics.goldCollected >= 2500) {
			badge = Badge.GOLD_COLLECTED_3;
			local.add( badge );
		}
		if (!local.contains( Badge.GOLD_COLLECTED_4 ) && com.shatteredpixel.shatteredpixeldungeon.Statistics.goldCollected >= 7500) {
	...
	public static void validateFoodEaten() {
		...
		if (!local.contains( Badge.FOOD_EATEN_1 ) && com.shatteredpixel.shatteredpixeldungeon.Statistics.foodEaten >= 10) {
			badge = Badge.FOOD_EATEN_1;
			local.add( badge );
		}
		if (!local.contains( Badge.FOOD_EATEN_2 ) && com.shatteredpixel.shatteredpixeldungeon.Statistics.foodEaten >= 20) {
			badge = Badge.FOOD_EATEN_2;
			local.add( badge );
		}
		if (!local.contains( Badge.FOOD_EATEN_3 ) && com.shatteredpixel.shatteredpixeldungeon.Statistics.foodEaten >= 30) {
			badge = Badge.FOOD_EATEN_3;
			local.add( badge );
		}
		if (!local.contains( Badge.FOOD_EATEN_4 ) && com.shatteredpixel.shatteredpixeldungeon.Statistics.foodEaten >= 40) {
	...
	public static void validatePotionsCooked() {
		...
		if (!local.contains( Badge.POTIONS_COOKED_1 ) && com.shatteredpixel.shatteredpixeldungeon.Statistics.potionsCooked >= 3) {
			badge = Badge.POTIONS_COOKED_1;
			local.add( badge );
		}
		if (!local.contains( Badge.POTIONS_COOKED_2 ) && com.shatteredpixel.shatteredpixeldungeon.Statistics.potionsCooked >= 6) {
			badge = Badge.POTIONS_COOKED_2;
			local.add( badge );
		}
		if (!local.contains( Badge.POTIONS_COOKED_3 ) && com.shatteredpixel.shatteredpixeldungeon.Statistics.potionsCooked >= 9) {
			badge = Badge.POTIONS_COOKED_3;
			local.add( badge );
		}
		if (!local.contains( Badge.POTIONS_COOKED_4 ) && com.shatteredpixel.shatteredpixeldungeon.Statistics.potionsCooked >= 12) {
	...
	public static void validatePiranhasKilled() {
		...
		if (!local.contains( Badge.PIRANHAS ) && com.shatteredpixel.shatteredpixeldungeon.Statistics.piranhasKilled >= 6) {
	...
	public static void validateMageUnlock(){
		if (com.shatteredpixel.shatteredpixeldungeon.Statistics.upgradesUsed >= 1 && !global.contains(Badge.UNLOCK_MAGE)){
			displayBadge( Badge.UNLOCK_MAGE );
		}
	}
	
	public static void validateRogueUnlock(){
		if (com.shatteredpixel.shatteredpixeldungeon.Statistics.sneakAttacks >= 10 && !global.contains(Badge.UNLOCK_ROGUE)){
			displayBadge( Badge.UNLOCK_ROGUE );
		}
	}
	
	public static void validateHuntressUnlock(){
		if (com.shatteredpixel.shatteredpixeldungeon.Statistics.thrownAssists >= 15 && !global.contains(Badge.UNLOCK_HUNTRESS)){
			displayBadge( Badge.UNLOCK_HUNTRESS );
		}
	}

	public static void validateSummonerUnlock(){
		if (com.shatteredpixel.shatteredpixeldungeon.Statistics.mirrorImageScrollUsed >= 3 && !global.contains(Badge.UNLOCK_SUMMONER)){
			displayBadge( Badge.UNLOCK_SUMMONER );
		}
	}
	...
	public static void validateGamesPlayed() {
		Badge badge = null;
		if (com.shatteredpixel.shatteredpixeldungeon.Rankings.INSTANCE.totalNumber >= 10) {
			badge = Badge.GAMES_PLAYED_1;
		}
		if (com.shatteredpixel.shatteredpixeldungeon.Rankings.INSTANCE.totalNumber >= 50) {
			badge = Badge.GAMES_PLAYED_2;
		}
		if (com.shatteredpixel.shatteredpixeldungeon.Rankings.INSTANCE.totalNumber >= 250) {
